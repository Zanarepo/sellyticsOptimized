        ...
        <table className="min-w-full">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {displayedSales.length === 0 ? (
                  ...
                  <tr key={s.id || idx} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    {isMultiStoreOwner && (
                      <td className="px-6 py-4">
                            <span className="px-4 py-2 bg-indigo-100 text-indigo-800 dark:bg-indigo-900/50 dark:text-indigo-200 rounded-full text-sm font-bold text-left block">
                        {shopName}
                      </span>
              ...
              >
                {s.dynamic_product?.name || s.product_name || 'Deleted Product'}
              </button>
               </td>
                <td className="px-6 py-4">{s.customer_name || 'N/A'}</td>
